...
3) Utiliser les boucles imbriquées pour afficher l'ensemble des tables de multiplication pour i <= n. Par exemple si l'utilisateur saisit le nombre 4,
on affiche alors les tables de multiplication des nombres 1, puis 2, puis 2 et enfin 4.
